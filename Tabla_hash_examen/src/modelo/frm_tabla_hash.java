...
DefaultTableModel tabla_entrada = new DefaultTableModel();
    /**
    ...
    public frm_tabla_hash() {
        ...
        String encabezado []={"Clave","Token"};
        tabla.setColumnIdentifiers(encabezado);
        tabla_entrada.setColumnIdentifiers(encabezado);
        tbl_salida.setModel(tabla);
        tbl_entrada.setModel(tabla_entrada);
    }
    ...
    private void initComponents() {
        ...
        tabla_salida = new javax.swing.JTabbedPane();
        ...
        tabla_salida.setBackground(new java.awt.Color(0, 255, 51));
        tabla_salida.setBorder(javax.swing.BorderFactory.createCompoundBorder());
        tabla_salida.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        tabla_salida.addTab("Texto", jScrollPane2);
        ...
        tabla_salida.addTab("Salida Consola", jScrollPane3);
        ...
        jScrollPane5.setViewportView(tbl_entrada);

        tabla_salida.addTab("Tabla Entrada", jScrollPane5);
        ...
        jScrollPane4.setViewportView(tbl_salida);

        tabla_salida.addTab("Tabla Salida", jScrollPane4);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tabla_salida, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(tabla_salida, javax.swing.GroupLayout.PREFERRED_SIZE, 336, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        while(st.hasMoreElements()){
            ...
            while(st2.hasMoreElements()){
                ...
                while(stp.hasMoreElements()){
                    ...
                    datos[0] = clave;
                    datos[1] = elementop.toString();
                    tabla_entrada.addRow(datos);
    ...
    private javax.swing.JTabbedPane tabla_salida;
